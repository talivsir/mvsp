    ...
    <header class="site-header transparent-top" id="siteHeader">
        <div class="container header-inner">
            ...
            <div class="header-actions">
                ...
                <a href="contact.php" class="btn btn-primary btn-animated header-cta" data-open-enquiry>
                    <span>Book Now</span>
                </a>
        ...
        <div class="mobile-slide-menu" id="mobileSlideMenu">
            <div class="mobile-menu-inner">
                ...
                <div class="mobile-menu-footer">
                    <a href="contact.php" class="btn btn-primary btn-full btn-animated" data-open-enquiry><span>Book Now</span></a>
